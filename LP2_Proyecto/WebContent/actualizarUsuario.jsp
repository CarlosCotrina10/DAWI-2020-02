				...
				<form action="crudUsu" method="post">
					<div class="form-group">
						<label for="exampleInputNombre1">Codigo de usuario: </label> <input
							...
							value="${data.codUsuario}" readonly>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="exampleInputApellido1">Apellido: </label> <input
							class="form-control" id="exampleInputApellido1"
							placeholder="Ingrese la descripcion del producto"
							name="txtApellido" value="${data.apellido}">
					</div>
					<div class="form-group">
						<label for="exampleInputFecha1">Distrito: </label> <select
					...
					<div class="form-group">
						<label for="exampleInputApellido1">Usuario: </label> <input
							class="form-control" id="exampleInputApellido1"
							placeholder="Ingrese la descripcion del producto"
							name="txtUsuario" value="${data.usuario}">
					</div>
					<div class="form-group">
						<label for="exampleInputApellido1">Clave: </label> <input
							class="form-control" id="exampleInputApellido1"
							placeholder="Ingrese la descripcion del producto" name="txtClave"
							value="${data.clave}">
					</div>
					<div class="form-group">
						<label for="exampleInputFecha1">Tipo: </label> <select
					...
					<button type="submit" class="btn btn-primary mb-3 float-right"
						name="btnes" value="a">Actualizar</button>
				</form>
				<br>
			</div>
		</div>
